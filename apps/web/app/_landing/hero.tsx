    ...
    <div className="container hero-inner">
      <div>
        ...
        <p className="hero-sub">
          Publish your side-project in 60 seconds. Let investors, collaborators, and AI agents find
          you — no polished decks, no cold DMs.
        </p>
        ...
        <div className="hero-meta">
          <div className="hero-meta-item">
            ...
            <span>
              <b>{counts.builders.toLocaleString()}</b> builders shipping
            </span>
          </div>
          <div className="hero-meta-item">
            <span className="live-dot" />
            <span>
              <b>{counts.today}</b> launched today
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="hero-stage" aria-hidden="true">
        <div className="float-card float-card--main">
          ...
          <div className="appcard-body">
            ...
            <p className="appcard-desc">Ambient soundscapes for deep work, generated on the fly.</p>
