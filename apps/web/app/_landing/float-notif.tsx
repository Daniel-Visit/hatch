...
export const FloatNotif = () => (
  <div className="float-card float-card--notif" style={{ padding: '10px 12px' }} aria-hidden="true">
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <div style={{ fontSize: 12, flex: 1 }}>
        <b>maria.r</b> <span style={{ color: 'var(--muted)' }}>liked</span>
        <br />
        <span style={{ color: 'var(--text-2)' }}>your project Lumen.fm</span>
      </div>
    </div>
  </div>
);
