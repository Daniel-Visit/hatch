...
| Data | Supabase (project `vcbdtjjkkwryvmqbflah`)       | 16 tables (all RLS-enabled), 5 SECURITY DEFINER functions, pg_cron jobs for ranking, Auth (GitHub + Google), Storage (`app-covers`), Realtime for messages and notifications                                 |
